...
def benchmark(classifier, X, y, k_th):
    scores = list()
...
def get_evaluation_scores():
    print("Reading file ...")
    data = open("data/all_snippets.txt")
    ...
    model_w2vec.save("data/models/word2vec.model")
    pickle.dump(libs_mapping, open("data/models/libs_mapping.model", "wb"))
    ...
    model_filename = "data/models/DT.model"
